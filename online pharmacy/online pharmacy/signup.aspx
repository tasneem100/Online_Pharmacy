<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="online_pharmacy.signup" %>
            ...
            <asp:Label ID="Label23" runat="server" Font-Names="Agency FB" Font-Size="Large" Text="Create Account"></asp:Label>
                ...
                <tr>
                    ...
                    <td class="auto-style13">
                        <input type="checkbox" onchange="document.getElementById('passtxt').type=this.checked ? 'text' : 'password'" >
